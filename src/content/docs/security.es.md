...
El framework hace SameSite cookies + token criptográfico + chequeo en tiempo constante automáticamente en cada action.
...
## Patrones exactos recientes de dogfooding 0.9.30 (aplicados a este mismo sitio)
